...
def create_file_in_same_dir(input_file_location: pl.Path, file_ending: str) -> pl.Path:
    '''
    ...
    can be changed with the file_ending parameter.

    Args:
        input_file_location (Path): the input file that defines the directory to put the new file in and
